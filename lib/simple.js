	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363230633084128@newsletter',
            newsletterName: '𝑻𝑼𝑹𝑩𝑶 𝑩𝑶𝑻🤺🔥', 
      sourceUrl: "https://whatsapp.com/channel/0029VaSQX1TI1rcbxtQZ5518",
      title: ':̗̀➛ ·˚𝑻𝑼𝑹𝑩𝑶 𝑩𝑶𝑻🤺🔥',
      body: 'أنضم للقناه',
      thumbnail: 'https://i.ibb.co/zxVG8P8/blob.jpg',
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363230633084128@newsletter", "120363230633084128@newsletter"]
let canalNombre = ["𝑻𝑼𝑹𝑩𝑶 𝑩𝑶𝑻🤺🔥", ":̗̀➛ ·˚𓏲𝚂𝙰𝙽𝙹𝙸🔥𝙱𝙾𝚃𐙚!𓍢"]
...
const img = 'https://e.top4top.io/p_3202ukxys1.jpg';
